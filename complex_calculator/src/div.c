 ...
 * @param[out] dum divison of two complex numbers
...
{
    complex dum;
    dum.real=(num1.real * num2.real+num1.img*num2.img)/(num2.real*num2.real+num2.img*num2.img);
    dum.img=(num2.img*num1.real - num1.img*num2.real)/(num2.real*num2.real+num2.img*num2.img);
    return dum;
}